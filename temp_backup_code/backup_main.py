...
gini_SafetyMed = CariSafety('med')
totalSafety_Med = TotalSafety('med')
...
gini_SafetyHigh = CariSafety('high')
totalSafety_High = TotalSafety('high')
...
totalPerson_2 = TotalPerson('2','small','med')
...
totalPerson_More = TotalPerson('More','small','med')
